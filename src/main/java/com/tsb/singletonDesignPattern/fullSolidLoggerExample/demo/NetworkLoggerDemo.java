package com.tsb.singletonDesignPattern.fullSolidLoggerExample.demo;

import com.tsb.singletonDesignPattern.fullSolidLoggerExample.core.Logger;
import com.tsb.singletonDesignPattern.fullSolidLoggerExample.decorators.HostnameDecorator;
import com.tsb.singletonDesignPattern.fullSolidLoggerExample.decorators.TimestampDecorator;
import com.tsb.singletonDesignPattern.fullSolidLoggerExample.impl.NetworkLogger;
import com.tsb.singletonDesignPattern.fullSolidLoggerExample.singleton.SingletonLogger;
